# Simple Angular + electron timer

This simple app is a stopwatch app developed with Angular and Electron.
...
``` bash
git clone https://github.com/pawelpaszki/ng-electron-timer.git
```
